...
function predict(projectId, computeRegion, modelId, filePath, scoreThreshold) {
   ...
   */
  // let projectId = `The GCLOUD_PROJECT string, e.g. "my-gcloud-project"`;
  // let computeRegion = `region-name, e.g. "us-central1"`;
  // let modelId = `id of the model, e.g. “ICN12345”`;
  // let filePath = `local text file path of content to be classified, e.g. "./resources/test.txt"`;
  // let scoreThreshold = `value between 0.0 and 1.0, e.g. "0.5"`;
