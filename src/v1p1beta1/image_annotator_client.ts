...
export class ImageAnnotatorClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.imageAnnotatorStub = gaxGrpc.createStub(
        opts.fallback ?
          (protos as protobuf.Root).lookupService('google.cloud.vision.v1p1beta1.ImageAnnotator') :
  ...
  batchAnnotateImages(
      ...
      Promise<[
        ...
        protosTypes.google.cloud.vision.v1p1beta1.IBatchAnnotateImagesRequest|undefined, {}|undefined
      ]>;
  batchAnnotateImages(
      request: protosTypes.google.cloud.vision.v1p1beta1.IBatchAnnotateImagesRequest,
      options: gax.CallOptions,
      callback: Callback<
          protosTypes.google.cloud.vision.v1p1beta1.IBatchAnnotateImagesResponse,
          protosTypes.google.cloud.vision.v1p1beta1.IBatchAnnotateImagesRequest|undefined,
          {}|undefined>): void;
/**
