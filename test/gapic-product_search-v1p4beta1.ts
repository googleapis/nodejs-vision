...
describe('v1p4beta1.ProductSearchClient', () => {
    ...
    describe('removeProductFromProductSet', () => {
        ...
        it('invokes removeProductFromProductSet with error', done => {
            ...
            client.removeProductFromProductSet(request, (err: FakeError, response: {}) => {
                assert(err instanceof FakeError);
                assert.strictEqual(err.code, FAKE_STATUS_CODE);
                assert(typeof response === 'undefined');
                done();
    ...
    describe('importProductSets', () => {
        it('invokes importProductSets without error', done => {
            ...
            client.importProductSets(request).then((responses: [Operation]) => {
    ...
    describe('purgeProducts', () => {
        it('invokes purgeProducts without error', done => {
            ...
            client.purgeProducts(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('listProductSets', () => {
        it('invokes listProductSets without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listProductSets = (actualRequest: {}, options: {}, callback: Callback) => {
    ...
    describe('listProductSetsStream', () => {
        it('invokes listProductSetsStream without error', done => {
            ...
            const stream = client.listProductSetsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
    ...
    describe('listProducts', () => {
        it('invokes listProducts without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listProducts = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listProductsStream', () => {
        it('invokes listProductsStream without error', done => {
            ...
            const stream = client.listProductsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listReferenceImages', () => {
        it('invokes listReferenceImages without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listReferenceImages = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listReferenceImagesStream', () => {
        it('invokes listReferenceImagesStream without error', done => {
            ...
            const stream = client.listReferenceImagesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listProductsInProductSet', () => {
        it('invokes listProductsInProductSet without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listProductsInProductSet = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
            client.listProductsInProductSet(request, (err: FakeError, response: {}) => {
                assert.ifError(err);
                assert.deepStrictEqual(response, expectedResponse);
                done();
            });
    ...
    describe('listProductsInProductSetStream', () => {
        it('invokes listProductsInProductSetStream without error', done => {
            ...
            const stream = client.listProductsInProductSetStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
